...
def create_payload (type, ip, port ,name, path='/sdcard/Viren/'):
...
def finaly (name):
    ...
    ip = d_list[1]
    port = d_list[2]
    k = create_payload (type, ip, port ,name, path='/sdcard/Viren/')
    print('\n')
